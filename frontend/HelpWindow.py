...
class HelpWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.text_load = QTextEdit("""
            ...
            Для этого необходимо кликнуть по кнопке "Режим работы", выбрать опцию "Вариант", затем указать номер нужного варианта от 1 до 100.<br><br>
        ...
        self.text_schema = QTextEdit("""
            ...
            Появится всплывающее окно с 2 вариантами действий:<br> 
                &nbsp;&nbsp;&nbsp;&nbsp;- добавить потомка;<br> 
                &nbsp;&nbsp;&nbsp;&nbsp;- добавить лист.<br> 
        ...
        self.text_costs = QTextEdit("""
            ...
            Для проверки и сохранения результата необходимо нажать кнопку "ОК".<br><br>
