    ...
    def __init__(self, parent=None):
        ...
        self.text_general = QTextEdit("""
            ...
            При решении задачи пользователь может работать в трех режимах:<br> 
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;- выбор стрелок.<br>
            Выбор режима решения определяется выпадающим меню, которое при запуске программы показывается в основном меню в виде кнопки "Построение схемы".
            При нажатии на эту кнопку пользователь может выбрать один из трех описанных выше режимов. <br>
